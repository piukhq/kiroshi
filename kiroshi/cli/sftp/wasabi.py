...
@click.option("-k", "--keypath", default="/tmp/wasabi", type=str, help="The Path to the Wasabi SFTP RSA Key")
@click.option(
    "-d",
    "--directories",
...
def wasabi(host: str, user: str, port: int, keypath: str, directories: str):
    """
